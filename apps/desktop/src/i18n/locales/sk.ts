...
export const sk = {
  ...
  app: {
    ...
    labels: {
      ...
      installMediaTools: "Inštalácia vo Windowse",
      mediaTools: "Multimediálne nástroje",
      commandSections: {
    ...
    status: {
      ...
      fastCutStarted: "Rýchly strih sa začal",
      fastCutting: "Prebieha rýchly strih…",
      fileDeleteCancelled: "Odstraňovanie súboru bolo zrušené",
      fileDeleteFailed: "Odstraňovanie súboru zlyhalo",
      ...
      fileRestoring: "Súbor sa obnovuje…",
      ...
      renderStarted: "Vykreslenie sa začalo",
      rendering: "Prebieha vykresľovanie…",
      workspaceRestored_one: "Obnovený {{count}} zdroj z predchádzajúcej relácie",
      workspaceRestored_other: "Obnovených {{count}} zdrojov z predchádzajúcej relácie",
      workspacePartiallyRestored:
        "Obnovené {{restored}} z {{total}} zdrojov z predchádzajúcej relácie",
    ...
    messages: {
      ...
      installMediaTools: "EasyTrim vyžaduje FFmpeg a FFprobe.",
      mediaToolsReady: "EasyTrim používa FFmpeg a FFprobe na kontrolu a spracovanie médií.",
      mediaToolsRestart: "Stále sa nenašli? Po inštalácii reštartujte EasyTrim.",
      mediaToolsTogether: "FFmpeg a FFprobe sa zvyčajne dodávajú spolu.",
      mediaToolsUnavailable: "EasyTrim vyžaduje FFmpeg a FFprobe.",
    ...
    workspaceRecovery: {
      ...
      dismiss: "Zavrieť",
      restore: "Obnoviť",
      restorePreviousSession: "Obnoviť predchádzajúcu reláciu",
  ...
  source: {
    ...
    messages: {
      ...
      emptyDescription: "Vyberte súbor alebo priečinok, prípadne sem presuňte videá a začnite.",
