...
export const sk = {
  ...
  webcam: {
    title: "Webkamera",
    add: "Pridať webkameru",
    replace: "Nahradiť webkameru",
    adding: "Otvára sa webkamera…",
    addTooltip: "Vyberte synchronizovaný záznam webkamery ako prekrytie.",
  ...
  export: {
    ...
    webcamSaveDisabledTooltip: "Prekrytie webkamery vyžaduje úplné vykreslenie videa.",
