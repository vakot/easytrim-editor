export const ru = {
  ...
  app: {
    ...
    labels: {
      ...
      installMediaTools: "Установка в Windows",
      mediaTools: "Медиатулы",
      commandSections: {
    ...
    messages: {
      ...
      installMediaTools: "EasyTrim требуется FFmpeg и FFprobe.",
      mediaToolsReady: "EasyTrim использует FFmpeg и FFprobe для проверки и обработки медиа.",
      mediaToolsRestart: "Всё ещё не найдено? Перезапустите EasyTrim после установки.",
      mediaToolsTogether: "FFmpeg и FFprobe обычно поставляются вместе.",
      mediaToolsUnavailable: "EasyTrim требуется FFmpeg и FFprobe.",
