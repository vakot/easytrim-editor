export const en = {
  ...
  webcam: {
    title: "Webcam",
    add: "Add webcam",
    replace: "Replace webcam",
    adding: "Opening webcam…",
    addTooltip: "Choose a synchronized webcam recording to overlay.",
    hide: "Hide webcam",
    show: "Show webcam",
    ...
    positions: {
      ...
      topLeftOffset: "Top left · inset",
      topRightOffset: "Top right · inset",
      bottomLeftOffset: "Bottom left · inset",
      bottomRightOffset: "Bottom right · inset",
    },
  },
  export: {
    save: "Save",
    ...
    webcamSaveDisabledTooltip: "A webcam overlay requires a full video render.",
    export: "Export",
