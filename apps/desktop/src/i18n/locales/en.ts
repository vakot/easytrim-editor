export const en = {
  ...
  app: {
    ...
    labels: {
      ...
      installMediaTools: "Install on Windows",
    ...
    status: {
      ...
      rendering: "Rendering…",
      workspaceRestored_one: "Restored {{count}} source from previous session",
      workspaceRestored_other: "Restored {{count}} sources from previous session",
      workspacePartiallyRestored:
        "Restored {{restored}} of {{total}} sources from previous session",
      installed: "Installed",
      missing: "Not found",
      toolsFailed: "Media tools check failed",
      toolsIssue: "Media tools issue",
    ...
    messages: {
      ...
      installMediaTools: "EasyTrim requires FFmpeg and FFprobe.",
      mediaToolsReady:
        "FFmpeg and FFprobe are used by EasyTrim for media inspection and processing.",
      mediaToolsRestart: "Still not detected? Restart EasyTrim after installation.",
      mediaToolsTogether: "FFmpeg and FFprobe normally ship together.",
      mediaToolsUnavailable: "EasyTrim requires FFmpeg and FFprobe.",
      ...
      workspaceRecovery: {
        ...
        toastPartialDescription: "{{restored}} of {{total}} sources restored",
        toastPartialTitle: "Previous session partially restored",
        toastTitle: "Previous session restored",
      },
    },
    tooltips: {
