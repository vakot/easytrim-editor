...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      className={cn(
        "min-w-0 font-heading text-base leading-none font-medium wrap-anywhere",
        className,
      )}
