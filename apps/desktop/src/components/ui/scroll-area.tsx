  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        className={cn(
          "scroll-area-viewport size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:outline-1 [&>div]:block!",
