  ...
  it("returns a newer stable release", async () => {
    vi.spyOn(globalThis, "fetch").mockResolvedValue(
      new Response(
        JSON.stringify({
          tag_name: "v0.2.0",
          html_url: "https://github.com/vakot/framelatch/releases/tag/v0.2.0",
          name: "FrameLatch 0.2.0",
          draft: false,
          prerelease: false,
        }),
        { status: 200 },
    ...
    await expect(checkForUpdate("0.1.0")).resolves.toEqual({
      ...
      version: "0.2.0",
      name: "FrameLatch 0.2.0",
      url: "https://github.com/vakot/framelatch/releases/tag/v0.2.0",
    });
  });
    ...
    vi.spyOn(globalThis, "fetch").mockResolvedValue(
      new Response(
        JSON.stringify({
          ...
          html_url: "https://github.com/vakot/framelatch/releases/tag/v0.1.0-beta.1",
          name: "Beta",
          draft: false,
          prerelease: true,
        }),
