...
| Native export process, timers, callbacks          | export queue runtime                                                               | enqueue/cancel/cleanup paths                                        | native adapter and runtime only                    | one job per attempt; release after terminal cleanup                  | never                |
